...
var xSROMap = (function () {
  ...
  var initLayers = function (id) {
    ...
    // Area layers
    // cave donwhang
    mappingLayers['32769'] = new SRLayer(
      imgHost + 'd/{z}/dh_a01_floor01_{x}x{y}.jpg',
      {
    ...
    // cave jangan
    mappingLayers['32775'] = new SRLayer(
      imgHost + 'd/{z}/qt_a01_floor01_{x}x{y}.jpg',
      {
        attribution:
          '<a href="#">Underground Level 1 of Tomb of Qui-Shin [B1]</a>',
      }
    );
    mappingLayers['32774'] = new SRLayer(
      imgHost + 'd/{z}/qt_a01_floor02_{x}x{y}.jpg',
      {
        attribution:
          '<a href="#">Underground Level 2 of Tomb of Qui-Shin [B2]</a>',
      }
    );
    mappingLayers['32773'] = new SRLayer(
      imgHost + 'd/{z}/qt_a01_floor03_{x}x{y}.jpg',
      {
        attribution:
          '<a href="#">Underground Level 3 of Tomb of Qui-Shin [B3]</a>',
      }
    );
    mappingLayers['32772'] = new SRLayer(
      imgHost + 'd/{z}/qt_a01_floor04_{x}x{y}.jpg',
      {
        attribution:
          '<a href="#">Underground Level 4 of Tomb of Qui-Shin [B4]</a>',
      }
    );
    mappingLayers['32771'] = new SRLayer(
      imgHost + 'd/{z}/qt_a01_floor05_{x}x{y}.jpg',
      {
        attribution:
          '<a href="#">Underground Level 5 of Tomb of Qui-Shin [B5]</a>',
      }
    );
    mappingLayers['32770'] = new SRLayer(
      imgHost + 'd/{z}/qt_a01_floor06_{x}x{y}.jpg',
      {
        attribution:
          '<a href="#">Underground Level 6 of Tomb of Qui-Shin [B6]</a>',
      }
    );
    // job temple
    ...
    mappingLayers['32783'] = new SRLayer(
      imgHost + 'd/{z}/rn_sd_egypt1_02_{x}x{y}.jpg',
      {
    ...
    mappingLayers['32785'] = new SRLayer(
      imgHost + 'd/{z}/fort_dungeon01_{x}x{y}.jpg',
      {
        attribution: '<a href="#">Cave of Meditation [1F]</a>',
      }
    );
    // mountain flame
    mappingLayers['32786'] = new SRLayer(
      imgHost + 'd/{z}/flame_dungeon01_{x}x{y}.jpg',
      {
        attribution: '<a href="#">Flame Mountain</a>',
      }
    );
    // jupiter rooms
    mappingLayers['32787'] = new SRLayer(
      imgHost + 'd/{z}/rn_jupiter_02_{x}x{y}.jpg',
      {
        attribution: '<a href="#">The Earth\'s Room</a>',
      }
    );
    mappingLayers['32788'] = new SRLayer(
      imgHost + 'd/{z}/rn_jupiter_03_{x}x{y}.jpg',
      {
        attribution: '<a href="#">Yuno\'s Room</a>',
      }
    );
    mappingLayers['32789'] = new SRLayer(
      imgHost + 'd/{z}/rn_jupiter_04_{x}x{y}.jpg',
      {
        attribution: '<a href="#">Jupiter\'s Room</a>',
      }
    );
    mappingLayers['32790'] = new SRLayer(
      imgHost + 'd/{z}/rn_jupiter_01_{x}x{y}.jpg',
      {
    ...
    // Bahdag room
    mappingLayers['32793'] = new SRLayer(
      imgHost + 'd/{z}/RN_ARABIA_FIELD_02_BOSS_{x}x{y}.jpg',
      {
  ...
  var initEvents = function () {
    ...
    map.on('dblclick', function (e) {
      ...
      var content =
        ...
        coord.region +
        (coord.region <= 32767
          ? ' (' + (coord.region & 0xff) + ',' + (coord.region >> 8) + ')'
          : '') +
        ' </b>]';
      ...
      // link shortcut
      var copyLink =
        '<a class="leaflet-popup-copy-button" title="Copy Link" href="#" onClick="xSROMap.LinkToClipboard(' +
        coord.x +
        ',' +
        coord.y +
        ',' +
  ...
  return {
    ...
    GoToNPC(id) {
      ...
      if (marker && marker.options.xMap.layer) {
        ...
        if (lastMarkerSelected) {
          // reset
          lastMarkerSelected._icon.style.zIndex =
            lastMarkerSelected._icon._leaflet_pos.y;
          L.DomUtil.removeClass(
            lastMarkerSelected._icon,
            'leaflet-marker-selected'
          );
    ...
    GoToPlayer(id) {
      ...
      if (marker && marker.options.xMap.layer) {
        ...
        lastMarkerSelected = marker;
        marker._icon.style.zIndex = Object.keys(
          mappingMarkers['player']
        ).length;
        L.DomUtil.addClass(marker._icon, 'leaflet-marker-selected');
        return true;
      }
    ...
    AddDrawingShape(type, param1, param2 = null) {
      ...
      switch (type) {
        ...
        case 'Polygon':
          ...
          shape =
            type == 'Polyline'
              ? L.polyline(latlngs, { virtual: true })
              : L.polygon(latlngs, { virtual: true });
          shape['xMap'] = {
            layer: getLayer(
              fixCoords(param1[0][0], param1[0][1], param1[0][2], param1[0][3])
            ),
          };
          // Add shape description
          if (param2 != null) shape['xMap']['desc'] = param2;
        ...
        case 'Circle':
          ...
          shape = L.circle(CoordSROToMap(coord), param2 / 192, {
            virtual: true,
          });
          shape['xMap'] = { layer: getLayer(coord) };
          break;
